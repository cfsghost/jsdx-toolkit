...
namespace JSDXToolkit {
	...
	extern "C" {
		static void init(Handle<Object> target)
		{
			...
			/* Effect */
			CLUTTER_DEFINE_CONSTANT(target, "EFFECT_CUSTOM", JDDX_TOOLKIT_EFFECT_CUSTOM);
			CLUTTER_DEFINE_CONSTANT(target, "EFFECT_BLUR", JDDX_TOOLKIT_EFFECT_BLUR);
			CLUTTER_DEFINE_CONSTANT(target, "EFFECT_COLORIZE", JDDX_TOOLKIT_EFFECT_COLORIZE);
			CLUTTER_DEFINE_CONSTANT(target, "EFFECT_DESATURATE", JDDX_TOOLKIT_EFFECT_DESATURATE);
			CLUTTER_DEFINE_CONSTANT(target, "EFFECT_PAGE_TURN", JDDX_TOOLKIT_EFFECT_PAGE_TURN);

			/* own events */
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_DESTROY", JDDX_TOOLKIT_EVENT_DESTROY);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_SHOW", JDDX_TOOLKIT_EVENT_SHOW);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_HIDE", JDDX_TOOLKIT_EVENT_HIDE);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_PRESS", JDDX_TOOLKIT_EVENT_PRESS);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_RELEASE", JDDX_TOOLKIT_EVENT_RELEASE);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_CLICK", JDDX_TOOLKIT_EVENT_CLICK);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_LONG_PRESS", JDDX_TOOLKIT_EVENT_LONG_PRESS);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_ENTER", JDDX_TOOLKIT_EVENT_ENTER);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_LEAVE", JDDX_TOOLKIT_EVENT_LEAVE);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_MOTION", JDDX_TOOLKIT_EVENT_MOTION);
			CLUTTER_DEFINE_CONSTANT(target, "EVENT_DRAG", JDDX_TOOLKIT_EVENT_DRAG);
			...
			/* Animation */
			CLUTTER_DEFINE_CONSTANT(target, "ANIMATION_PLAY", JDDX_TOOLKIT_ANIMATION_PLAY);
			CLUTTER_DEFINE_CONSTANT(target, "ANIMATION_PAUSE", JDDX_TOOLKIT_ANIMATION_PAUSE);
			CLUTTER_DEFINE_CONSTANT(target, "ANIMATION_STOP", JDDX_TOOLKIT_ANIMATION_STOP);
