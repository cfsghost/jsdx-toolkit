...
namespace JSDXToolkit {
	...
	extern "C" {
		static void init(Handle<Object> target)
		{
			...
			/* Effect */
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EFFECT_CUSTOM", JDDX_TOOLKIT_EFFECT_CUSTOM);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EFFECT_BLUR", JDDX_TOOLKIT_EFFECT_BLUR);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EFFECT_COLORIZE", JDDX_TOOLKIT_EFFECT_COLORIZE);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EFFECT_DESATURATE", JDDX_TOOLKIT_EFFECT_DESATURATE);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EFFECT_PAGE_TURN", JDDX_TOOLKIT_EFFECT_PAGE_TURN);

			/* own events */
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_DESTROY", JDDX_TOOLKIT_EVENT_DESTROY);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_SHOW", JDDX_TOOLKIT_EVENT_SHOW);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_HIDE", JDDX_TOOLKIT_EVENT_HIDE);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_PRESS", JDDX_TOOLKIT_EVENT_PRESS);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_RELEASE", JDDX_TOOLKIT_EVENT_RELEASE);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_CLICK", JDDX_TOOLKIT_EVENT_CLICK);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_LONG_PRESS", JDDX_TOOLKIT_EVENT_LONG_PRESS);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_ENTER", JDDX_TOOLKIT_EVENT_ENTER);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_LEAVE", JDDX_TOOLKIT_EVENT_LEAVE);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_MOTION", JDDX_TOOLKIT_EVENT_MOTION);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "EVENT_DRAG", JDDX_TOOLKIT_EVENT_DRAG);
			...
			/* Animation */
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "ANIMATION_PLAY", JDDX_TOOLKIT_ANIMATION_PLAY);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "ANIMATION_PAUSE", JDDX_TOOLKIT_ANIMATION_PAUSE);
			JSDX_TOOLKIT_DEFINE_CONSTANT(target, "ANIMATION_STOP", JDDX_TOOLKIT_ANIMATION_STOP);
