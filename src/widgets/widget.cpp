...
namespace JSDXToolkit {
	...
	void Widget::Initialize(Handle<Object> target)
	{
		...
		/* Constants */
		JSDX_TOOLKIT_DEFINE_CONSTANT(ClassObject, "ORIENTATION_HORIZONTAL", JDDX_TOOLKIT_WIDGET_ORIENTATION_HORIZONTAL);
		JSDX_TOOLKIT_DEFINE_CONSTANT(ClassObject, "ORIENTATION_VERTICAL", JDDX_TOOLKIT_WIDGET_ORIENTATION_VERTICAL);
