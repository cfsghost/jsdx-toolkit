...
namespace JSDXToolkit {
	...
	void FlickView::Initialize(Handle<Object> target)
	{
		...
		CLUTTER_DEFINE_CONSTANT(tpl, "MODE_FREE_STYLE", JDDX_TOOLKIT_WIDGET_FLICKVIEW_MODE_FREE_STYLE);
		CLUTTER_DEFINE_CONSTANT(tpl, "MODE_PAGE_STYLE", JDDX_TOOLKIT_WIDGET_FLICKVIEW_MODE_PAGE_STYLE);

		CLUTTER_DEFINE_CONSTANT(tpl, "EVENT_DRAG_BEGIN", JDDX_TOOLKIT_WIDGET_FLICKVIEW_EVENT_DRAG_BEGIN);
		CLUTTER_DEFINE_CONSTANT(tpl, "EVENT_ANIMATION_COMPLETED", JDDX_TOOLKIT_WIDGET_FLICKVIEW_EVENT_ANIMATION_COMPLETED);
