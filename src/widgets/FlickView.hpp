#ifndef JDDX_TOOLKIT_WIDGETS_FLICKVIEW_H_
#define JDDX_TOOLKIT_WIDGETS_FLICKVIEW_H_
...
typedef enum {
	JDDX_TOOLKIT_WIDGET_FLICKVIEW_X_AXIS = (1 << 0),
	JDDX_TOOLKIT_WIDGET_FLICKVIEW_Y_AXIS = (1 << 1)
} FlickViewAxis;

typedef enum {
	JDDX_TOOLKIT_WIDGET_FLICKVIEW_MODE_FREE_STYLE,
	JDDX_TOOLKIT_WIDGET_FLICKVIEW_MODE_PAGE_STYLE
} FlickViewMode;

typedef enum {
	JDDX_TOOLKIT_WIDGET_FLICKVIEW_EVENT_DRAG_BEGIN = 1000,
	JDDX_TOOLKIT_WIDGET_FLICKVIEW_EVENT_ANIMATION_COMPLETED
} FlickViewEvent;
