#ifndef JSDX_TOOLKIT_WIDGET_ADJUSTMENT_H_
#define JSDX_TOOLKIT_WIDGET_ADJUSTMENT_H_
...
protected:
	...
	static v8::Handle<v8::Value> ClampValueGetter(v8::Local<v8::String> name, const v8::AccessorInfo& info);
	static void ClampValueSetter(v8::Local<v8::String> name, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
